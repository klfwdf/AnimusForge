...
public partial class RewardSystemBehavior : CampaignBehaviorBase
{
	...
	{
		return RecruitmentOwner.TryApplyHeroJoinPlayerPartyCore(this, joiningHero, asCompanion, out statusText, out joinedWildernessParty, out joinedWildernessMembers, out joinedWildernessPrisoners);
	}
	...
	{
		return RecruitmentOwner.TryApplyNonHeroJoinPlayerPartyForExternal(joiningCharacter, targetAgentIndex, promptGivenName, promptDisplayName, latestReply, asCompanion, out statusText, out promotedHero);
	}
	...
	{
		return RecruitmentOwner.TryPromoteNonHeroToCompanion(joiningCharacter, targetAgentIndex, promptGivenName, promptDisplayName, latestReply, asCompanion, out statusText, out promotedHero);
	}
