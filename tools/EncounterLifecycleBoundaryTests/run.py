...
def main():
    ...
    (output / "Boundary.csproj").write_text('<Project Sdk="Microsoft.NET.Sdk"><PropertyGroup><OutputType>Exe</OutputType><TargetFramework>net8.0</TargetFramework><ImplicitUsings>disable</ImplicitUsings><Nullable>disable</Nullable><NoWarn>CS0649;CS0414</NoWarn></PropertyGroup><ItemGroup><Compile Include="../../src/modules/AF.Module.Encounter/EncounterTargetOwner.cs" Link="EncounterTargetOwner.cs" /><Compile Include="../../src/modules/AF.Module.Encounter/EncounterReleaseOwner.cs" Link="EncounterReleaseOwner.cs" /><Compile Include="../../src/modules/AF.Module.Encounter/EncounterPendingReturnOwner.cs" Link="EncounterPendingReturnOwner.cs" /></ItemGroup></Project>', encoding="utf-8")
