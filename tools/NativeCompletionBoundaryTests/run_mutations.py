...
for mutation in ['drop-generation','current-scene','late-nonhero','drop-context','drop-close-guard','backend-close','drop-completion','capture-after-start','drop-discard-context','drop-memory-acceptance','lose-owner-scene','accept-owner-false','drop-memory-thread','public-scene-owner','lose-failed-exit']:
