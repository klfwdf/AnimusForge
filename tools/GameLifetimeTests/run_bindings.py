...
files=[out/'Program.cs']+[ROOT/p for p in ['Refactor/Runtime/PendingOperationRegistry.cs','PreprocessFormatException.cs','MyBehavior.CampaignLifetime.cs','ShoutBehavior.CampaignLifetime.cs','CourierDeliveryBehavior.CampaignLifetime.cs']]
