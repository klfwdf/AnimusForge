...
shout=(ROOT/'ShoutBehavior.cs').read_text(encoding='utf-8-sig');courier=(ROOT/'CourierDeliveryBehavior.DetachedPostprocess.cs').read_text(encoding='utf-8-sig')
...
files=[out/'Program.cs']+[ROOT/p for p in ['src/AF.Foundation.Runtime/Scheduling/PendingOperationRegistry.cs','PreprocessFormatException.cs','MyBehavior.CampaignLifetime.cs','ShoutBehavior.CampaignLifetime.cs','CourierDeliveryBehavior.CampaignLifetime.cs']]
