...
paths=['ShoutBehavior.NativeAdmission.cs','ShoutBehavior.NativeCompletion.cs','ShoutBehavior.NativeActionDispatch.cs','ShoutBehavior.ModuleNativeSubmission.cs','Refactor/Runtime/PendingOperationRegistry.cs','src/modules/AF.Module.PublicApi/V1/AfApi.cs','src/AF.Contracts/PublicApi/V1/AfApiContracts.cs','src/modules/AF.Module.PublicApi/V1/AfDialogueClient.cs','src/modules/AF.Module.PublicApi/Internal/AfV1DialogueProjection.cs','src/modules/AF.Module.PublicApi/Internal/AfV1SnapshotProjection.cs','Refactor/Modules/CoreDialogueContracts.cs','Refactor/Modules/CoreDialogueOperation.cs','Refactor/Modules/CoreDialogueClient.cs','Refactor/Modules/CoreDialogueServices.cs','src/AF.Foundation.Runtime/ModuleDirectory/ModuleFrameworkSnapshot.cs','src/AF.Foundation.Runtime/ModuleDirectory/InternalModuleDirectory.cs','src/AF.Foundation.Runtime/ModuleDirectory/ModuleDirectoryLifecycleOwner.cs','Refactor/Modules/ModuleFrameworkRuntime.cs','Refactor/Modules/TeamModuleRegistration.cs','Refactor/Contracts/FeatureBridgeContracts.cs']
mutations={
 ...
 'skip-conversation':('ShoutBehavior.ModuleNativeSubmission.cs','|| conversationEpoch != Interlocked.Read(ref _nativeConversationAdmissionEpoch)','|| false'),
 'skip-revision':('ShoutBehavior.ModuleNativeSubmission.cs','|| presentationRevision != Interlocked.Read(ref _nativeConversationPresentationRevision)','|| false')}
