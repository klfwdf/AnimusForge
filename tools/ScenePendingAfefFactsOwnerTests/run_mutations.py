"""Compile effective mutations of the production pending Scene AFEF owner."""
...
MUTATIONS = {
    ...
    "unbounded": (
        ...
        "while (false)",
        "bounded-oldest-eviction",
    ),
    "cross-agent-consume": (
        "_factsByAgent.Remove(targetAgentIndex);",
        "_factsByAgent.Remove(8);",
        "agents-are-isolated",
    ),
}
...
def main() -> int:
    ...
    print(f"ScenePendingAfefFactsOwner mutations={len(MUTATIONS)} FAIL={failed}")
