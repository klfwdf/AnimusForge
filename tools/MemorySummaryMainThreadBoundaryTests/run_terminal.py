...
def main():
    ...
    (out/'run.log').write_bytes((run.stdout+run.stderr).encode());print('BUILD_PASS terminal='+str(a.mutate or 'current'));print(run.stdout+run.stderr,end='')
