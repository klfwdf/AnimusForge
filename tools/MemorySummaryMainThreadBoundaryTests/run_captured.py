...
MUTATIONS=['retain-payload','reuse-source','ignore-fingerprint','worker-parse','skip-retry-source','drop-afef','drop-overview-ids','drop-major-cursor','background-sanitize-alias','main-sanitize-detach','drop-source-receipt','ignore-wave-lifetime']
def main():
    ...
    elif a.mutate=='reuse-source':capture=mutation(capture,'return JsonConvert.DeserializeObject<T>(JsonConvert.SerializeObject(value));','return value;')
