...
METHODS=['private static string NormalizeMemoryHeroId(','private static bool IsNonHeroMemoryId(','private static List<MemorySummaryJob> SanitizeMemorySummaryQueue(','private static List<MajorActionSummaryJob> SanitizeMajorActionSummaryQueue(','private static List<MemoryOverviewJob> SanitizeMemoryOverviewQueue(','private bool CancelUnavailableHeroCompressionWorkById(','private static bool IsDailyMaintenanceBudgetExceeded(']
def main():
