...
- Remaining joint owner work: MyBehavior still needs live AFEF/old-save acceptance and detached Scene session forwarding review; mixed/partial Economy outcomes after a successful preflight, failed post-commit callbacks and broader Courier corruption/lifecycle recovery need explicit handling. These are not solved by cache or fixture PASS.
