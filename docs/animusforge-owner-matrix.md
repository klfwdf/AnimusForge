...
- Remaining joint owner work: MyBehavior still needs live AFEF/old-save acceptance and detached Scene session forwarding review; durable memory-only/afterCommit recovery and broader Courier corruption/lifecycle recovery need explicit handling. Structured unknown receipts prevent unsafe replay but do not compensate effects or survive receipt-cache eviction/restart.
